...
#define TP_K 16             // deal with TP_K samples in every outer_loop
#define LOOP_N BSIZE / TP_K // number of outer loop

// Hardware: can be calculate
#define P0 128               // UNROLL factor of input layer(L0)
#define P1 2048               // UNROLL factor of hidden layer(L1)
#define P2 1024               // UNROLL factor of output layer(L2)
#define P3 112
#define U1 (P1 / L1)        // U1 = 2
#define U1_LOOP (TP_K / U1) // looptime = 1
#define U2 (P2 / L2)        // U2 = 2
#define U2_LOOP (TP_K / U2) // looptime = 1
#define U3 (P3 / L3)        // U3 = 1
